  ...
  <div class="app">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="nav">
        ...
        <a href="#"><i class="fa-solid fa-user-tie"></
 i        ><span>Staffs</span></a>

                   <a href="{{ route('admin.officials.index') }}" cla
        s s="{{ request()->routeIs('admin.officials.*') ? 'active' : '' }}"><i class="
     f      a-solid fa-user-group"></i><span>Barangay Officials</span></a>
