...
<div class="app">
  <header class="topbar">
    ...
    <div class="top-actions">
      ...
      <div class="user-dropdown">
        ...
        <div class="dropdown-menu"><a href="{{ route('admin.users.create') }}">User Profile</a><form method="POST" action=""><button type="submit">Logout</button></form></div>
      </div>
    </div>
  </header>
  <aside class="sidebar" id="sidebar"> 
    ...
    <nav class="nav">
      ...
      <a href="{{ route('admin.users.index') }}" class="{{ request()->routeIs('admin.users.*') ? 'active' : '' }}"><i class="fa-solid fa-users"></i><span>Users</span></a>
