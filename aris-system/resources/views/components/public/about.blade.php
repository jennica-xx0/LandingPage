<div class="bg-base-100 py-16 px-4 sm:px-8">
    <div class="container mx-auto max-w-5xl">
        ...
        <div class="prose max-w-none text-justify font-serif mb-12">
            <p>
            ...
            <p><br>
                Barangay Daang Bakal is located within the city and has a total land area of 16.74 hectares, which constitute 1.54% of the total land area of Mandaluyong City of 1,124.97 hectares. It is one of the barangays which belongs to District I by Local Political Division. It is composed of 10 streets namely, Sen. Gonzales formerly Daang Bakal, P. Martinez, Shaw Boulevard, N. Romualdez, Haig, F. Bernando, Magalona, V. Fabella, J. Tiosejo, and General Kalentong.
            </p>
            <p><br>
                Barangay Daang Bakal is prone to flood due to its location. One of its corners is bound in San Juan River and Maytunays Creek which is both bodies of water.
            </p>
            <p><br>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="rounded-lg shadow-lg h-[600px] flex items-center justify-center overflow-hidden">
                <img src="/img/kap1.jpg" alt="Award Poster 1" class="max-w-full max-h-full object-contain">
            </div>
            <div class="rounded-lg shadow-lg h-[600px] flex items-center justify-center overflow-hidden">
                <img src="/img/kap2.jpg" alt="Award Poster 2" class="max-w-full max-h-full object-contain">
            </div>
        </div>
