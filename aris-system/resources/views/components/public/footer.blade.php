<footer class="bg-[#134573] text-white">
  <div class="max-w-7xl mx-auto px-6 py-10">
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
      ...
      <section class="lg:col-span-2">
        ...
        <a href="https://www.google.com/maps/place/Daang+Bakal+Barangay+Hall/@14.5916363,121.0244769,17.25z/data=!4m6!3m5!1s0x3397c9d1e1d1726f:0xbf347c81708454e1!8m2!3d14.5916105!4d121.0286076!16s%2Fg%2F1pzr9z8pz?entry=ttu"
          ...
          <img
            ...
            loading="lazy"
            class="w-full object-cover transition-transform duration-300 group-hover:scale-[1.01]
      ...
      <section class="space-y-8">
        <nav>
          ...
          <ul class="space-y-3 text-white/90">
            ...
            <li class="flex items-start gap-3">
              ...
              <a href="tel:+630635353992" class="link link-hover">(+63) 0535-3992</a>
            </li>
            <li class="flex items-start gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
        ...
        <nav>
          <h6 class="footer-title text-white/90 mb-3">Visit Us</h6>
          <ul class="space-y-3 text-white/90">
            <li class="flex items-start gap-3">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li class="flex items-start gap-3">
              ...
              <a href="#" class="link link-hover pt-1">Barangay Daang Bakal – Sangguniang Kabataan</a>
            </li>
          </ul>
        </nav>
      </section>
  ...
  <div class="footer footer-center p-4 border-t border-white/10">
    <aside>
      <p>© 2025 ARIS: Automated Record and Information System</p>
    </aside>
  </div>
</footer>