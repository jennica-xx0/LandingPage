@php
    // Mock data array for the announcement list
    $announcements = [
        (object)[
            'date' => '2024-10-21',
        ...
        (object)[
            'date' => '2024-10-17',
            'date_range' => '17-20', // Optional property for date ranges
...
<div class="bg-base-100 py-16 px-4 sm:px-8">
    <div class="container mx-auto max-w-5xl">
        ...
        <div class="max-w-4xl mx-auto px-5 flex flex-row gap-4 items-center">
            <img src="{{ asset('/img/announcement.png') }}" alt="Announcement Icon" class="h-10">
            <div class="form-control w-full">
                <label class="relative block w-full">
                    ...
                    <input type="text" name="q" placeholder="Search announcements..." class="input input-bordered w-full bg-transparent pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-slate-300" />
                </label>
            </div>
        </div>
        ...
        <div class="space-y-6 max-w-4xl mx-auto mt-4">
            ...
            <div class="flex items-start space-x-6 p-4 pl-0 rounded-lg hover:bg-base-200 transition-colors duration-200 cursor-pointer">
                <div class="text-center flex-shrink-0 w-20">
                    <p class="text-xl font-bold text-blue-800">{{ \Carbon\Carbon::parse($announcement->date)->format('M') }}</p>
                    <p class="text-2xl font-bold">{{ $announcement->date_range ?? \Carbon\Carbon::parse($announcement->date)->format('d') }}</p>
                </div>
