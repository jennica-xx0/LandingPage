...
<div class="space-y-8">
    ...
    <div class="card table-wrap">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="5" class="text-center py-4">No announcements found for the selected status.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="flex justify-end items-center gap-3 pt-4">
        ...
        <span class="bg-gray-300 text-gray-500 font-bold py-2 px-4 rounded-full cursor-not-allowed">
            &lt;&lt; PREVIOUS
        </span>
        @else
        <a href="{{ $announcements->previousPageUrl() }}" class="bg-[#a2c4d9] text-black font-bold py-2 px-4 rounded-full hover:bg-opacity-90">
            &lt;&lt; PREVIOUS
        </a>
        @endif
        ...
        <a href="{{ $announcements->nextPageUrl() }}" class="bg-[#a2c4d9] text-black font-bold py-2 px-4 rounded-full hover:bg-opacity-90">
            NEXT &gt;&gt;
        </a>
        @else
        <span class="bg-gray-300 text-gray-500 font-bold py-2 px-4 rounded-full cursor-not-allowed">
    ...
    <div class="exact-modal__panel" role="document" aria-labelledby="modalTitle">
        ...
        <form id="announcementForm" method="POST" action="">
            ...
            <div class="exact-modal__body">
                ...
                <div class="block"><label for="start_date" class="lbl">Start Date:</label>
                    <div class="exact-date__wrap"><input type="date" name="start_date" id="start_date" class="input exact-input"><span class="exact-date__icon"><i class="fa-solid fa-calendar-days"></i></span></div>
                </div>
                <div class="block"><label for="end_date" class="lbl">End Date:</label>
                    <div class="exact-date__wrap"><input type="date" name="end_date" id="end_date" class="input exact-input"><span class="exact-date__icon"><i class="fa-solid fa-calendar-days"></i></span></div>
                </div>
            </div>
...
<div id="viewAnnouncementModal" class="exact-modal" aria-hidden="true" role="dialog">
    ...
    <div class="exact-modal__panel" role="document">
        ...
        <div class="exact-modal__body">
            ...
            <div class="block"><label class="lbl">Start Date:</label>
                <div class="exact-date__wrap"><input type="text" id="view_start_date" class="input exact-input" readonly></div>
            </div>
            <div class="block"><label class="lbl">End Date:</label>
                <div class="exact-date__wrap"><input type="text" id="view_end_date" class="input exact-input" readonly></div>
            </div>
        </div>
        <div class="exact-modal__footer">
...
<style>
    ...
    #view_start_date+.exact-date__icon,
    #view_end_date+.exact-date__icon {
        pointer-events: none;
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (viewModal) {
            ...
            function openViewModal(button) {
                ...
                viewStartEl.value = a.start_date ? new Date(a.start_date).toLocaleDateString('en-US', {
                    month: '2-digit',
                    day: '2-digit',
                    year: 'numeric'
                }) : 'N/A';
                viewEndEl.value = a.end_date ? new Date(a.end_date).toLocaleDateString('en-US', {
                    month: '2-digit',
                    day: '2-digit',
                    year: 'numeric'
                }) : 'N/A';
